...
print(not (1 == 1 and 0 != 1)) # True / исправляю на False так как not (True and True) -> False
print(not (10 == 1 or 1000 == 1000)) # False
print(not (1 != 10 or 3 == 4)) # True / исправляю на False так как not (True or False) -> False
...
print(3 == 3 and not ('testing' == 'testing' or 'Python' == 'Fun')) # True / исправляю на False, так как not(True or False) -> False
